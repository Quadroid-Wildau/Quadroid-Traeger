...
public class RxDataDecoderTest {
	...
	public void setUp() throws Exception {
		...
		QuadroidMain.logger = LoggerFactory.getLogger(RxDataDecoderTest.class
				.getName());
		...
		this.validairplane = new String(
				encoder.quadroidairplaneToBytes(refairplane));
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#byteToBufferedImage(byte[])}
	 * .
	 */
	@Test
	public void testbyteToBufferedImage()
	{
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToAttitude(java.lang.String)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToGNSS(java.lang.String)}
	 * .
	 */
	@Test
	public void testStringToGNSS() {
		...
		try {
			...
			// if no correct data available return value are null it is
			// necessary
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToCourse(java.lang.String)}
	 * .
	 */
	@Test
	public void testStringToCourse() {
		...
		assertTrue(course.getAngleReference() == this.refcourse
				.getAngleReference());
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToAirplane(java.lang.String)}
	 * .
	 */
	@Test
	public void testStringToAirplane() {
		// hand over an valid string contains protocol specific data to prove
		// decoder
		Airplane airplane = decoder.stringToAirplane(validairplane);
		// prove results
		assertNotNull(airplane);
		// prove contain data
		assertTrue(airplane.getBatteryState() == this.refairplane
				.getBatteryState());
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToWaypoint(java.lang.String)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToMetaData(java.lang.String)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.th_wildau.quadroid.decoder.RxDataDecoder#stringToLandmark(java.lang.String)}
	 * .
	 */
	@Test
	public void testStringToLandmark() { 
		// hand over an sring contains valid
											// data for testing decoder
